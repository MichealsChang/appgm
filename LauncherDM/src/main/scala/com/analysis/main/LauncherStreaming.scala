...
import com.analysis.util.{DataUtil, LauncherMultipleTextOutputFormat}
...
//    println(parseLog(str))
        ...
        val kafkaStream = KafkaUtils.createStream(
          ...
          StorageLevel.MEMORY_AND_DISK_SER).map(_._2) // 获取消息主题信息
