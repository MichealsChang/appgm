 ...
 */
public class MyMultipleTextOutputFormatNew<K, V> extends MultipleTextOutputFormat<K, V> {
    ...
    public RecordWriter getRecordWriter(final FileSystem fs, final JobConf job, final String name, final Progressable arg3) throws IOException {
        ...
        return new RecordWriter() {
            ...
            public void write(Object key, Object value) throws IOException {
                ...
                // 完整文件路径名
                String dir = "/changmi/new/arrival_data/" + key.toString() + name;
//                String dir = "/changmi/new/arrival_data/" + key.toString() + name.substring(name.length() - 3);
                // 内容
